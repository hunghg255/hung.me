    ...
    <IphoneSimulator className='overflow-hidden bg-white'>
      <MotionConfig transition={{ duration: 0.8, type: 'spring', bounce: 0.2 }}>
        <div className='px-4 pt-4 text-black'>
            ...
            >
              ...
              <div className='absolute bottom-0 left-0 isolate w-full'>
                ...
                <div className='-translate-y-4 translate-x-4'>
                  ...
                  <motion.h2 layoutId='top-title-layout' className='text-2xl font-bold text-white'>
                ...
                >
                  ...
                  <motion.div layoutId='bottom-text-layout'>
                    ...
                    <p className='text-xs text-white opacity-55'>War games and naval battle...</p>
                  </motion.div>
                  <motion.div
                    ...
                    style={{ flex: '0 0 auto' }}
                  >
                    <Button className='h-7 w-14 rounded-full bg-white/30 text-white'>Get</Button>
                    <small className='text-[7px] text-white/55'>In-App Purchases</small>
                  </motion.div>
                </motion.div>
              </div>
            </motion.div>
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div layoutId='wrapper' className='absolute inset-0 bg-white'>
                <motion.div
                  whileTap={{ scale: 0.97 }}
                ...
                >
                  <p className='text-lg leading-6 text-[#959597]'>
                    ...
                    explicabo <b className='text-black'>cupiditate</b> libero aliquid ea fuga iure
                    aut minima possimus! Deleniti veritatis dicta eligendi veniam quaerat saepe
                    doloribus itaque debitis.
                  </p>
