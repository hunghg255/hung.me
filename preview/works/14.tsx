      ...
      <MotionConfig transition={{ duration: 0.5, type: 'spring', bounce: 0.2 }}>
              ...
              >
                <header className='flex h-12 items-center gap-1 px-2'>
                  <div className='relative isolate h-8 w-8'>
                    ...
                    >
                      <Image src='/my-image.jpeg' alt='logo' fill className='rounded-lg' />
                    </motion.div>
                    <motion.button
                  ...
                  <motion.div layoutId='wrapper-user-info' className='-space-y-px'>
                    <h2 className='text-sm font-bold'>Hung Hoang</h2>
        ...
        <div className='no-scrollbar mt-2 flex h-[600px] flex-col gap-4 overflow-auto p-2'>
          {messages.map((message) => (
            <div key={`demo14-${Math.random()}`} className='flex items-start gap-2'>
              <div className='relative h-8 w-8 shrink-0 rounded-lg bg-white'>
                <Image src={message.avatar_url} alt='logo' fill className='rounded-lg' />
              </div>
              <div className='-mt-1'>
                <div className='flex items-center gap-2'>
