  ...
  return (
    <IphoneSimulator className='bg-natural-900 text-white [&_[data-top]]:bg-transparent'>
      <MotionConfig transition={{ duration: 0.5, type: 'spring', bounce: 0.2 }}>
        ...
        >
          {!isActive && (
            <motion.h1 layoutId='title' className='text-7xl font-bold tracking-tighter'>
              50%
            </motion.h1>
          )}
        </motion.div>
        ...
        {isActive && (
          <div className='px-4'>
            ...
            >
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Porro praesentium ducimus
                maxime perspiciatis eligendi accusantium soluta. Aliquam sint blanditiis, amet
                temporibus eligendi aperiam reprehenderit consequuntur dicta laudantium beatae
                ratione rerum.
              </p>
            </motion.div>
          </div>
